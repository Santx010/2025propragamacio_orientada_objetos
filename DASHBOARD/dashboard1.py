...
def mostrar_menu():
    ...
    while True:
        ...
        if seleccion_carpeta == '0':  # Si elige 0, salimos del programa
            ...
            ruta_elegida = carpetas_disponibles[  # Obtiene la ruta de la carpeta seleccionada
                int(seleccion_carpeta) - 1]
...
def mostrar_archivos(ruta_carpeta):
    ...
    while True:
        ...
        if seleccion_archivo == '0':  # Si elige 0, volvemos al menú de unidades
            ...
            ruta_script = os.path.join(ruta_carpeta, archivos_py[  # Obtiene la ruta del archivo seleccionado
                int(seleccion_archivo) - 1])
